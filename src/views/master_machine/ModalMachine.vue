  ...
  >
    <CModalHeader>
      <CModalTitle id="LiveDemoExampleLabel"
        >{{ mode === 'update' ? 'Edit' : mode === 'delete' ? 'Delete' : 'Add' }} Machine
        Data</CModalTitle
      >
    </CModalHeader>
    ...
    <CModalBody v-else>
      Are you sure you want to delete this Machine with ID : {{ idMachine }}, Machine Address :
      {{ machineAddress }}, Actual Shot : {{ actualShot }}, Limit Shot : {{ limitShot }} ?
    </CModalBody>
    <CModalFooter>
      ...
      <CButton
        ...
        @click="
          mode === 'update' ? updateMachine() : mode === 'delete' ? deleteMachine() : addMachine()
        "
      >
    ...
    const updateMachine = async () => {
      try {
        const response = await axios.patch(
          `http://192.168.148.125:5000/machine/${idMachine.value}`,
          {
